...
- `src/web/features/skills/skill-registry.js` — prompt SRS #2 + `buildFinalizePrompt` (cho phép nhiều vòng); prompt testcase: openQuestions kèm "Gợi ý:", thứ tự tổng quan→chi tiết, coverage-driven, giải thích suite.
